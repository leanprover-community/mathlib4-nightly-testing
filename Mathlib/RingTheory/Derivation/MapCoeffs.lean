...
lemma mapCoeffs_monomial (n : ℕ) (x : A) :
  ...
  -- TODO: This should work: `simp [coeff_monomial, apply_ite d, PolynomialModule.single_apply]`
  rw [PolynomialModule.single_apply, mapCoeffs_apply, coeff_monomial, apply_ite d, map_zero]
